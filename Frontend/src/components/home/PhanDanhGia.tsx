...
const testimonials = [
    ...
    { name: "Anh Tuấn", pet: "Chủ của Capy - Chuột lang nước", text: "Phòng khám xịn xò thực sự! Đưa bé đi khám mà có cảm giác như vào resort 5 sao. Không gian sạch, bác sĩ ân cần và quy trình rất chuyên nghiệp. Đánh giá 10 điểm!", star: 5, avatar: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=150", petAvatar: "https://files.catbox.moe/xzcfyx.png" },
    { name: "Chị Thanh Tâm", pet: "Chủ của Leo - Chó Corgi", text: "Thao thức vì bé Corgi bị ốm, nhưng qua Rexi thì bác sĩ chữa đỉnh luôn! Dịch vụ 10 điểm, phòng khám siêu xịn xò. Mãi yêu Rexi!", star: 5, avatar: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=150", petAvatar: "https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=150&q=80" },
    { name: "Chị Mai Linh", pet: "Chủ của Kitty - Mèo Ba Tư", text: "Bé Kitty nhà mình bị sỏi thận, đội ngũ Rexi xử lý nhanh và rất chuyên nghiệp. Phòng nội trú thơm tho sạch sẽ, bé được chăm sóc tận tình 24/7 luôn nè.", star: 5, avatar: "https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=150", petAvatar: "https://images.unsplash.com/photo-1513360371669-4adf3dd7dff8?auto=format&fit=crop&w=150&q=80" },
    { name: "Em Ngọc Anh", pet: "Chủ của Bống - Mèo ta", text: "Phòng khám tuyệt vời lắm luôn á, hôm trước mang bé mèo qua tiêm phòng mà bác sĩ làm nhẹ nhàng cực kỳ, bé xíu xiu mà không đau khóc gì luôn. Mãi yêu!", star: 5, avatar: "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150", petAvatar: "https://images.unsplash.com/photo-1511044568932-338cba0ad803?auto=format&fit=crop&w=150&q=80" },
