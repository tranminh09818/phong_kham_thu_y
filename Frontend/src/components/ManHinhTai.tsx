...
import { TrinhPhatLottie } from "./HieuUngDacBiet";

/* màn hình chờ tải trang */
export const ManHinhTai: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '250px', height: '250px', marginBottom: '-20px' }}>
        <TrinhPhatLottie url="https://assets9.lottiefiles.com/packages/lf20_tr1pjkop.json" />
      </div>
