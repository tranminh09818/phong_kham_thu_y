...
import com.rexi.pkty.security.BoLocJwt;
...
/**
 * C?U H�NH B?O M?T H? TH?NG REXI (�� d?i t�n sang ti?ng Vi?t)
 */
@Configuration
@EnableWebSecurity
public class CauHinhBaoMat {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:3001", "http://localhost:5173", "http://localhost:5174", "https://accounts.google.com"));
