...
4. **Code comments**: Code comments MUST be written in clear, friendly, and readable Vietnamese (Tiếng Việt). Avoid writing comments in English under any circumstances, as it makes sếp uncomfortable. Standard code variables and class names remain in English.
...
> 🔴 **MANDATORY:** AI BẮT BUỘC phải đọc file `@[rules/CORE_MEMORY]` (`.agent/rules/CORE_MEMORY.md`) ở đầu mỗi phiên làm việc để nạp các thói quen, bài học và cấu hình đã tự học được. Tuyệt đối không được bỏ qua bước này.
